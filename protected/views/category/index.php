    ...
    <div class="df-container">
        ...
        <ul class="list-child-category">
            <li><a href="">
                    ...
                    <h2 class="cat-name">Quần nam</h2>
                </a></li>
            <li><a href="">
                    <span class="bg-image" style="background-image: url('<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/sample/card13.jpg')"></span>
                    <span class="bg-gradient"></span>
                    <h2 class="cat-name">Áo nam</h2>
                </a></li>
            <li><a href="">
                    <span class="bg-image" style="background-image: url('<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/sample/card24.jpg')"></span>
                    <span class="bg-gradient"></span>
                    <h2 class="cat-name">Giày dép & Phụ kiện</h2>
                </a></li>
            <li><a href="">
                    <span class="bg-image" style="background-image: url('<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/sample/card26.jpg')"></span>
                    <span class="bg-gradient"></span>
                    <h2 class="cat-name">Quần áo nam khác</h2>
                </a></li>
        </ul>
    </div>
</div>
            ...
            <div class="card-item card-hide">
                <div class="card-item-inner">
                    <div class="post-image card-image has-one-image">
                        <a href="#" data-featherlight=".lightbox-post">
            ...
            <div class="card-item card-hide">
                <div class="card-item-inner">
                    <div class="post-image card-image hasTwoImages">
                        <a href="#"  data-featherlight=".singlePostWrap">
